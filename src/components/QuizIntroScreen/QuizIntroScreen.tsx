...
const QUIZ_CONFIGS: Record<string, QuizConfig> = {
  ...
  'gama-cyber': {
    ...
    subtitle: 'מבחן גאמא סייבר מלא – 40 שאלות ברמות קושי עולות: יסודות מחשוב, רשתות, תכנות Python ו-JavaScript, חולשות אבטחה וקריפטוגרפיה.',
    stats: [
      { value: '40', label: 'שאלות' },
      { value: '40', label: 'דקות זמן מבחן' },
      { value: '70%', label: 'ציון עובר' },
      { value: 'מאתגר', label: 'רמת קושי' },
    ],
    about: [
      'מבחן גאמא סייבר מלא – 40 שאלות ברמות עולות מבסיסי ועד מתקדם.',
      'יסודות מחשוב: CPU, RAM/ROM, סיביות, מערכת הפעלה.',
      'רשתות: DNS, IP, TCP/IP, SSH, Subnet Mask, ARP, IDS/IPS.',
      'תכנות: קוד Python וזיהוי פלט, פונקציות, רשימות ורקורסיה.',
      'חולשות אבטחה: SQL Injection, Path Traversal, Buffer Overflow, CSRF.',
      'קריפטוגרפיה: RSA, AES, MD5, TLS, Nonce, Base64 ו-Spear Phishing.',
    ],
    instructions: [
  ...
  'dafar': {
    fileKey: 'dafar',
    title: 'מבחן דפ"ר לדוגמה - צו ראשון',
    subtitle: 'מבחן דפ"ר לדוגמה – אנלוגיות מילוליות, צורנים ויחסי קשר, הבנת הוראות ומתמטיקה. כולל שאלות צורניות עם תמונות.',
    stats: [
      { value: '12', label: 'שאלות' },
      { value: '16', label: 'דקות זמן מבחן' },
      { value: '60%', label: 'ציון עובר' },
      { value: 'בינוני', label: 'רמת קושי' },
    ],
    about: [
      'מבחן דפ"ר לדוגמה – מדמה את אופי שאלות מבחן דפ"ר האמיתי בצו ראשון.',
      'אנלוגיות מילוליות – זיהוי קשרים לוגיים בין מילים ומושגים (ספר:מדף, נגר:בונה).',
      'צורנים – שאלות עם תמונות של סדרות גיאומטריות (זיהוי הצורה הבאה בסדרה).',
      'הבנת הוראות – קריאת תנאים ויישום הוראה מורכבת.',
      'מתמטיקה ומספרים – אחוזים, קצב עבודה, מהירות, פרמוטציות וחשבון.',
    ],
    instructions: [
      'קראו כל שאלה בעיון לפני שאתם עונים.',
      'הזמן מתחיל מרגע תחילת המבחן ואינו ניתן לעצירה.',
      'לאחר סיום המבחן ניתן לסקור את התשובות.',
      'בשאלות הצורניות – שימו לב לדפוסים בגודל, צבע וסיבוב הצורות.',
    ],
    password: '4747',
  },
