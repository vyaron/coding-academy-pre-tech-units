...
const PROFESSIONS = [
  {
    emoji: "💻",
    title: "תוכניתן או תוכניתנית",
    desc: "עבודה בסביבות פיתוח מתקדמות, בחזית הטכנולוגיה, שימוש במבני נתונים ואלגוריתמיקה.",
  },
  {
    emoji: "🤖",
    title: "מגיני סייבר",
    desc: "הגנה על מערכות, איתור חולשות, הקשחות, מניעה ותגובה לאירועי סייבר .",
  },
  {
    emoji: "🔐",
    title: "אבטחה והאקינג רשתות",
    desc: "פריצות, חדירות, הדבקות והתקפות סייבר — האתגר המרתק של הזירה הטכנולוגית.",
  },
  {
    emoji: "🌐",
    title: "אנשי DevOps",
    desc: "פריסה, ניטור ותפעול של מערכות ברמת סודיות מגוונת, אוטומציה ושרידות, עבודה בארכיטקטורות מודרניות בענן.",
  },
];
        ...
        <div className="lp-purchase-overlay" onClick={() => setPurchaseOpen(false)}>
          <div className="lp-purchase-modal" dir="rtl" onClick={e => e.stopPropagation()}>
            ...
            <ul className="lp-purchase-bullets">
              <li>בדיקת זיקה טכנולוגית: הבנה מהירה של המוכנות והפוטנציאל להשתלבות בעולם הטכנולוגיה.</li>
              <li>נחיתה רכה במיונים: היכרות ממוקדת עם מבנה המבחנים ודרישות הסף של היחידות הנחשקות.</li>
              <li>זיקוק נושאי הליבה: למידה מרוכזת של יסודות התכנות, מבנה המחשב ורשתות – הבסיס שחובה להכיר.</li>
              <li>מיני-קורס דיגיטלי: שיעורי וידאו קצרים בעברית מאת המרצים המוסמכים של קודינג אקדמי.</li>
            </ul>
            ...
            <a
              href="https://secure.cardcom.solutions/EA/EA5/xJZr3vSHC0ORd1McAWGe1A/PaymentSP"
              target="_blank"
